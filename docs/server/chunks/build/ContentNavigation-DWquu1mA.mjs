import { r as useState, g as useContent, y as useAsyncData, D as fetchContentNavigation, a as __nuxt_component_0$6 } from './server.mjs';
...
const ContentNavigation = defineComponent({
  ...
  render(ctx) {
    ...
    const renderLink = (link) => h(__nuxt_component_0$6, { to: link._path }, () => link.title);
...
//# sourceMappingURL=ContentNavigation-DWquu1mA.mjs.map
