...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/@nuxt-themes/elements/components/icons/IconNuxtContent.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const IconNuxtContent = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { IconNuxtContent as default };
//# sourceMappingURL=IconNuxtContent-D2K7SKxw.mjs.map
