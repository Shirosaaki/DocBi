...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/@nuxt-themes/elements/components/icons/IconNuxtLabs.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const IconNuxtLabs = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { IconNuxtLabs as default };
//# sourceMappingURL=IconNuxtLabs-C4_r2g6_.mjs.map
