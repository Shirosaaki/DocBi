import { N as createQuery, b as useNuxtApp, f as useRuntimeConfig, k as useContentPreview, H as omit, E as get$1, F as assertArray, G as ensureArray, I as sortList, J as apply, K as withoutKeys, M as withKeys } from './server.mjs';
import { R as prefixStorage, S as createStorage, T as memoryDriver, v as withBase, P as pascalCase, p as joinURL } from '../runtime.mjs';
import 'vue';
...
function createMatch(opts = {}) {
  ...
  function match(item, conditions) {
    ...
    return Object.keys(conditions || {}).every((key) => {
      ...
      return match(get$1(item, key), condition);
    });
  }
  return match;
}
...
//# sourceMappingURL=client-db-CznfFgoS.mjs.map
