...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<h6${ssrRenderAttrs(mergeProps({ id: _ctx.id }, _attrs))} data-v-913dabe3>`);
...
const ProseH6 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-913dabe3"]]);

export { ProseH6 as default };
//# sourceMappingURL=ProseH6-D1xMGxRi.mjs.map
