  ...
  async highlighter(code, lang, theme, options) {
    try {
      if (globalThis._importMeta_.browser && window.sessionStorage.getItem("mdc-shiki-highlighter") === "browser") {
        return import('../runtime.mjs').then(function (n) { return n.V; }).then((h) => h.default(code, lang, theme, options)).catch(() => ({}));
      }
...
const highlight = {"theme":{"dark":"github-dark","default":"github-light"}};
