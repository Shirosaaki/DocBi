import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, h, defineAsyncComponent, toRef, isRef, computed, shallowRef, onServerPrefetch, defineComponent, provide, createElementBlock, useSSRContext, unref, shallowReactive, Suspense, nextTick, Fragment, Transition, resolveComponent, createVNode, resolveDynamicComponent, mergeProps, withCtx, renderSlot, withAsyncContext, openBlock, createBlock, createCommentVNode, toDisplayString, createTextVNode, readonly, renderList, createApp, effectScope, reactive, getCurrentScope, onScopeDispose, onErrorCaptured, isReadonly, isShallow, isReactive, toRaw } from 'vue';
import { $ as $fetch$1, w as withoutTrailingSlash, o as withLeadingSlash, p as joinURL, q as hash, r as klona, t as defu, v as withBase, x as parseQuery, y as defuFn, z as withTrailingSlash, A as hasProtocol, B as createHooks, l as createError$1, C as parse, D as getRequestHeader, E as isScriptProtocol, F as withQuery, G as destr, H as isEqual, I as setCookie, J as getCookie, K as deleteCookie, L as sanitizeStatusCode, M as toRouteMatcher, N as createRouter$1, O as kebabCase } from '../runtime.mjs';
import { b as baseURL } from '../routes/renderer.mjs';
import { CapoPlugin, getActiveHead } from 'unhead';
import { defineHeadPlugin, composableNames } from '@unhead/shared';
import { RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'vue-router';
import { nanoid } from 'nanoid';
import { ssrRenderVNode, ssrRenderSlot, ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderClass, ssrRenderTeleport, ssrRenderAttr, ssrRenderStyle, ssrRenderSuspense } from 'vue/server-renderer';
...
const _routes = [
  {
    name: "slug",
    path: "/:slug(.*)*",
    component: () => import('./document-driven-B-o4ORS6.mjs').then((m) => m.default || m)
  }
];
...
const LazyDocumentDrivenNotFound = defineAsyncComponent(() => import('./DocumentDrivenNotFound-CyWKwr3P.mjs').then((r) => r["default"] || r.default || r));
const LazyEllipsis = defineAsyncComponent(() => import('./Ellipsis-orEeuXv3.mjs').then((r) => r["default"] || r.default || r));
...
const LazyDocsAside = defineAsyncComponent(() => import('./DocsAside-HZCW_D7O.mjs').then((r) => r["default"] || r.default || r));
const LazyDocsAsideTree = defineAsyncComponent(() => Promise.resolve().then(function() {
  return DocsAsideTree;
}).then((r) => r["default"] || r.default || r));
const LazyDocsPageBottom = defineAsyncComponent(() => import('./DocsPageBottom-CADoUNHO.mjs').then((r) => r["default"] || r.default || r));
const LazyDocsPageLayout = defineAsyncComponent(() => import('./DocsPageLayout-BzodRnWZ.mjs').then((r) => r["default"] || r.default || r));
const LazyDocsPrevNext = defineAsyncComponent(() => import('./DocsPrevNext-BaHxdGFO.mjs').then((r) => r["default"] || r.default || r));
const LazyDocsToc = defineAsyncComponent(() => import('./DocsToc-BTAiSTmx.mjs').then((r) => r["default"] || r.default || r));
const LazyDocsTocLinks = defineAsyncComponent(() => import('./DocsTocLinks-CHi5LWJq.mjs').then((r) => r["default"] || r.default || r));
const LazyEditOnLink = defineAsyncComponent(() => import('./EditOnLink-CxozTxY3.mjs').then((r) => r["default"] || r.default || r));
const LazySourceLink = defineAsyncComponent(() => import('./SourceLink-Doi5I1b4.mjs').then((r) => r["default"] || r.default || r));
const LazyProseA = defineAsyncComponent(() => import('./ProseA-BP_J0uHw.mjs').then((r) => r["default"] || r.default || r));
const LazyProseBlockquote = defineAsyncComponent(() => import('./ProseBlockquote-D-Ms7MBF.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCode = defineAsyncComponent(() => import('./ProseCode-DpCOl6Xr.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCodeInline = defineAsyncComponent(() => import('./ProseCodeInline-A7NlJz3y.mjs').then((r) => r["default"] || r.default || r));
const LazyProseEm = defineAsyncComponent(() => import('./ProseEm-De9pqEQS.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-CpXr7Ncf.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-CIs2SF_E.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-Ld_Eb58l.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-C-eJWNmY.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-p9NPC5Y4.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-D1xMGxRi.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-DUDu4C_I.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-54xxBoZp.mjs').then((r) => r["default"] || r.default || r));
const LazyProseLi = defineAsyncComponent(() => import('./ProseLi-DrKQiGEh.mjs').then((r) => r["default"] || r.default || r));
const LazyProseOl = defineAsyncComponent(() => import('./ProseOl-d4vCsaWI.mjs').then((r) => r["default"] || r.default || r));
const LazyProseP = defineAsyncComponent(() => import('./ProseP-Dtlg0if_.mjs').then((r) => r["default"] || r.default || r));
const LazyProseStrong = defineAsyncComponent(() => import('./ProseStrong-7qQjXUzE.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTable = defineAsyncComponent(() => import('./ProseTable-B8e2Sutk.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTbody = defineAsyncComponent(() => import('./ProseTbody-CES608sj.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTd = defineAsyncComponent(() => import('./ProseTd-CulwC2YX.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTh = defineAsyncComponent(() => import('./ProseTh-Dx1VZSe3.mjs').then((r) => r["default"] || r.default || r));
const LazyProseThead = defineAsyncComponent(() => import('./ProseThead-GLERJDCP.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTr = defineAsyncComponent(() => import('./ProseTr-Dak6rR4B.mjs').then((r) => r["default"] || r.default || r));
const LazyProseUl = defineAsyncComponent(() => import('./ProseUl-2-MTH2bR.mjs').then((r) => r["default"] || r.default || r));
const LazyAlert = defineAsyncComponent(() => import('./Alert-Cm2-dFpA.mjs').then((r) => r["default"] || r.default || r));
const LazyBadge = defineAsyncComponent(() => import('./Badge-CIH5GDEX.mjs').then((r) => r["default"] || r.default || r));
const LazyButtonLink = defineAsyncComponent(() => import('./ButtonLink-C2-Cucz7.mjs').then((r) => r["default"] || r.default || r));
const LazyCallout = defineAsyncComponent(() => import('./Callout-CrXXFnaI.mjs').then((r) => r["default"] || r.default || r));
const LazyCodeBlock = defineAsyncComponent(() => import('./CodeBlock-hNKflu9B.mjs').then((r) => r["default"] || r.default || r));
const LazyCodeGroup = defineAsyncComponent(() => import('./CodeGroup-VvzTrnxI.mjs').then((r) => r["default"] || r.default || r));
const LazyContainer = defineAsyncComponent(() => Promise.resolve().then(function() {
  return Container;
}).then((r) => r["default"] || r.default || r));
const LazyCopyButton = defineAsyncComponent(() => import('./CopyButton-CmoKIQTD.mjs').then((r) => r["default"] || r.default || r));
const LazyList = defineAsyncComponent(() => import('./List-36RdmFxM.mjs').then((r) => r["default"] || r.default || r));
const LazyNuxtImg = defineAsyncComponent(() => import('./NuxtImg-BlBCUr8y.mjs').then((r) => r["default"] || r.default || r));
const LazyProps = defineAsyncComponent(() => import('./Props-DoZreZod.mjs').then((r) => r["default"] || r.default || r));
const LazySandbox = defineAsyncComponent(() => import('./Sandbox-COqaLPk1.mjs').then((r) => r["default"] || r.default || r));
const LazyTabsHeader = defineAsyncComponent(() => import('./TabsHeader-ChQXi7AT.mjs').then((r) => r["default"] || r.default || r));
const LazyTerminal = defineAsyncComponent(() => import('./Terminal-BX4UxwX2.mjs').then((r) => r["default"] || r.default || r));
const LazyVideoPlayer = defineAsyncComponent(() => import('./VideoPlayer-lo64GPyE.mjs').then((r) => r["default"] || r.default || r));
const LazyIconCodeSandBox = defineAsyncComponent(() => import('./IconCodeSandBox-BCpcJjuF.mjs').then((r) => r["default"] || r.default || r));
const LazyIconDocus = defineAsyncComponent(() => import('./IconDocus-Cb2_5HhO.mjs').then((r) => r["default"] || r.default || r));
const LazyIconNuxt = defineAsyncComponent(() => import('./IconNuxt-Bt1yKOqT.mjs').then((r) => r["default"] || r.default || r));
const LazyIconNuxtContent = defineAsyncComponent(() => import('./IconNuxtContent-D2K7SKxw.mjs').then((r) => r["default"] || r.default || r));
const LazyIconNuxtLabs = defineAsyncComponent(() => import('./IconNuxtLabs-C4_r2g6_.mjs').then((r) => r["default"] || r.default || r));
const LazyIconNuxtStudio = defineAsyncComponent(() => import('./IconNuxtStudio-3ngYgM5R.mjs').then((r) => r["default"] || r.default || r));
const LazyIconStackBlitz = defineAsyncComponent(() => import('./IconStackBlitz-vPEkU7xa.mjs').then((r) => r["default"] || r.default || r));
const LazyIconVueTelescope = defineAsyncComponent(() => import('./IconVueTelescope-BDRTWrlU.mjs').then((r) => r["default"] || r.default || r));
const LazyBlockHero = defineAsyncComponent(() => import('./BlockHero-CoBFF-_R.mjs').then((r) => r["default"] || r.default || r));
const LazyCard = defineAsyncComponent(() => import('./Card-Dhr8mAoR.mjs').then((r) => r["default"] || r.default || r));
const LazyCardGrid = defineAsyncComponent(() => import('./CardGrid-c_WNU8N2.mjs').then((r) => r["default"] || r.default || r));
const LazyVoltaBoard = defineAsyncComponent(() => import('./VoltaBoard-JewK03To.mjs').then((r) => r["default"] || r.default || r));
const LazyComponentPlayground = defineAsyncComponent(() => import('./ComponentPlayground-DvwMlIK5.mjs').then((r) => r["default"] || r.default || r));
const LazyComponentPlaygroundData = defineAsyncComponent(() => import('./ComponentPlaygroundData-B6vKHl-S.mjs').then((r) => r["default"] || r.default || r));
const LazyComponentPlaygroundProps = defineAsyncComponent(() => import('./ComponentPlaygroundProps-DteKYBvV.mjs').then((r) => r["default"] || r.default || r));
const LazyComponentPlaygroundSlots = defineAsyncComponent(() => import('./ComponentPlaygroundSlots-LQAtWwPl.mjs').then((r) => r["default"] || r.default || r));
const LazyComponentPlaygroundTokens = defineAsyncComponent(() => import('./ComponentPlaygroundTokens-Dpp38m-H.mjs').then((r) => r["default"] || r.default || r));
const LazyPreviewLayout = defineAsyncComponent(() => import('./PreviewLayout-BDQZ_8bp.mjs').then((r) => r["default"] || r.default || r));
const LazyTokensPlayground = defineAsyncComponent(() => import('./TokensPlayground-DaLOU1zr.mjs').then((r) => r["default"] || r.default || r));
const LazyContentDoc = defineAsyncComponent(() => import('./ContentDoc-DT7NY5H5.mjs').then((r) => r["default"] || r.default || r));
const LazyContentList = defineAsyncComponent(() => import('./ContentList-De8O9KDp.mjs').then((r) => r["default"] || r.default || r));
const LazyContentNavigation = defineAsyncComponent(() => import('./ContentNavigation-DWquu1mA.mjs').then((r) => r["default"] || r.default || r));
const LazyContentQuery = defineAsyncComponent(() => import('./ContentQuery-xOkc0Te3.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRenderer = defineAsyncComponent(() => import('./ContentRenderer-uxV-8Iaz.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./ContentRendererMarkdown-6SyhiBFO.mjs').then((r) => r["default"] || r.default || r));
const LazyContentSlot = defineAsyncComponent(() => import('./ContentSlot-B9JnsD_e.mjs').then((r) => r["default"] || r.default || r));
const LazyDocumentDrivenEmpty = defineAsyncComponent(() => import('./DocumentDrivenEmpty-CVfz7tly.mjs').then((r) => r["default"] || r.default || r));
const LazyMarkdown = defineAsyncComponent(() => import('./Markdown-C11P8Vfm.mjs').then((r) => r["default"] || r.default || r));
const LazyProsePre = defineAsyncComponent(() => import('./ProsePre-Bz5KoFrg.mjs').then((r) => r["default"] || r.default || r));
...
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-Ddr2emTy.mjs').then((r) => r["default"] || r.default || r));
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-CznfFgoS.mjs').then((m) => m.useContentDatabase());
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-CznfFgoS.mjs').then((m) => m.generateNavigation);
...
const layouts = {
  default: () => import('./default-CBCw8SPq.mjs').then((m) => m.default || m),
  page: () => import('./page-CeonS-MN.mjs').then((m) => m.default || m)
};
const documentDriven_cMiI6j6ghD = /* @__PURE__ */ defineNuxtPlugin((nuxt) => {
  ...
  const findLayout = (to, page, navigation2, globals2) => {
    ...
    if (to.matched[0] && ((_a3 = to.matched[0].meta) == null ? void 0 : _a3.layout)) {
...
function usePinceauRuntimeSheet($tokens, initialUtils = {}, colorSchemeMode, appId2) {
  const sheet = ref();
  ...
  function resolveStylesheet() {
    ...
    if (global2 && global2.document) {
      const fullId = `pinceau-runtime${appId2 ? `-${appId2}` : ""}`;
      ...
      hydratableSheet = doc.querySelector(`style#pinceau-runtime-hydratable${appId2 ? `-${appId2}` : ""}`);
    }
...
const plugin = {
  install(app, options) {
    ...
    if (dev && true) {
      import('./debug-D3OgqYpy.mjs').then(({ usePinceauRuntimeDebug }) => usePinceauRuntimeDebug(tokensHelperConfig));
    }
...
const __nuxt_component_0$5 = _sfc_main$i;
...
const __nuxt_component_0$4 = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["__scopeId", "data-v-2596513f"]]);
...
const _sfc_main$g = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    ((_a2 = appConfig == null ? void 0 : appConfig.nuxtIcon) == null ? void 0 : _a2.aliases) || {};
    const props = __props;
    const state = useState("icons", () => ({}));
    const isFetching = ref(false);
    const iconName = computed(() => {
      var _a3;
      return (((_a3 = appConfig.nuxtIcon) == null ? void 0 : _a3.aliases) || {})[props.name] || props.name;
    });
    const icon = computed(() => {
      var _a3;
    ...
    const sSize = computed(() => {
      var _a3, _b, _c;
      if (!props.size && typeof ((_a3 = appConfig.nuxtIcon) == null ? void 0 : _a3.size) === "boolean" && !((_b = appConfig.nuxtIcon) == null ? void 0 : _b.size)) {
        return void 0;
      }
    ...
    const className = computed(() => {
      var _a3;
      return ((_a3 = appConfig == null ? void 0 : appConfig.nuxtIcon) == null ? void 0 : _a3.class) ?? "icon";
    });
...
const __nuxt_component_0$3 = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["__scopeId", "data-v-e610b8e3"]]);
...
const __nuxt_component_0$2 = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["__scopeId", "data-v-d42239fd"]]);
...
function useClipboard(options = {}) {
  ...
  function legacyRead() {
    var _a2, _b, _c;
    return (_c = (_b = (_a2 = void 0) == null ? void 0 : _a2.call(void 0)) == null ? void 0 : _b.toString()) != null ? _c : "";
  }
  return {
    isSupported,
    text: text2,
...
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    watch(selected, (value) => {
      ...
      if (nextId) (_d = (void 0).querySelector(`[id="${nextId}"]`)) == null ? void 0 : _d.scrollIntoView({ block: "nearest" });
    });
    watch(
      q,
      (_) => {
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_ClientOnly = __nuxt_component_0$7;
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_AppLoadingBar = __nuxt_component_0$5;
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-lLRS3_fz.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-CpEo07vb.mjs').then((r) => r.default || r));
...
export { useVModel as A, usePinceauTheme as B, queryContent as C, fetchContentNavigation as D, get$1 as E, assertArray as F, ensureArray as G, omit as H, sortList as I, apply as J, withoutKeys as K, LayoutMetaSymbol as L, withKeys as M, createQuery as N, PageRouteSymbol as P, _export_sfc as _, __nuxt_component_0$6 as a, useNuxtApp as b, useRoute as c, appLayoutTransition as d, entry$1 as default, _wrapIf as e, useRuntimeConfig as f, useContent as g, useRequestEvent as h, useContentHead as i, usePinceauRuntime as j, useContentPreview as k, layouts as l, computedStyle as m, __nuxt_component_0$3 as n, useDocus as o, __nuxt_component_0$2 as p, useAppConfig as q, useState as r, __nuxt_component_0$4 as s, useContentHelpers as t, useHead as u, useRouter as v, useClipboard as w, onClickOutside as x, useAsyncData as y, useColorMode as z };
